...
This repository is a dockerized implementation of the Bayesian linear regression using `PyMC3` package. It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- A **Bayesian Linear Regressor** algorithm built using **PyMC3**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Bayesian linear regression model implemented using **PyMC3** library.
